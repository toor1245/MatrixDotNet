...
namespace MatrixDotNet.Extensions.Performance.Simd.Handler
{
    internal static class IntrinsicsHandler<T> where T : unmanaged
    {
        ...
        private static readonly Vector256<int> _blockMultiplyMask =
            Vector256.Create(16, 32, 64, 128, 256, 512, 1024, 2048);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool CanMultiply(int value)
        {
            return Avx2.IsSupported && IsSupportedMultiplyAddVector256 && ContainsMultiplyMask(value);
        }
        ...
        {
            var sum = default(T);
            for (var i = 0; i < Vector256<T>.Count; i++) sum = MathUnsafe<T>.Add(sum, a.GetElement(i));
            return sum;
        }
        ...
        {
            var sum = default(T);
            for (var i = 0; i < Vector128<T>.Count; i++) sum = MathUnsafe<T>.Add(sum, a.GetElement(i));
            return sum;
        }
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Avx2.Add(va.As<T, sbyte>(), vb.As<T, sbyte>()).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Avx2.Add(va.As<T, byte>(), vb.As<T, byte>()).As<byte, T>();
            if (typeof(T) == typeof(short)) return Avx2.Add(va.As<T, short>(), vb.As<T, short>()).As<short, T>();
            if (typeof(T) == typeof(ushort)) return Avx2.Add(va.As<T, ushort>(), vb.As<T, ushort>()).As<ushort, T>();
            if (typeof(T) == typeof(int)) return Avx2.Add(va.As<T, int>(), vb.As<T, int>()).As<int, T>();
            if (typeof(T) == typeof(uint)) return Avx2.Add(va.As<T, uint>(), vb.As<T, uint>()).As<uint, T>();
            if (typeof(T) == typeof(long)) return Avx2.Add(va.As<T, long>(), vb.As<T, long>()).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Avx2.Add(va.As<T, ulong>(), vb.As<T, ulong>()).As<ulong, T>();
            if (typeof(T) == typeof(float)) return Avx.Add(va.As<T, float>(), vb.As<T, float>()).As<float, T>();
            if (typeof(T) == typeof(double)) return Avx.Add(va.As<T, double>(), vb.As<T, double>()).As<double, T>();
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Avx2.Shuffle(va.As<T, sbyte>(), vb.As<T, sbyte>()).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Avx2.Shuffle(va.As<T, byte>(), vb.As<T, byte>()).As<byte, T>();
        ...
        {
            if (typeof(T) == typeof(int)) return Avx2.Shuffle(va.As<T, int>(), control).As<int, T>();
            if (typeof(T) == typeof(uint)) return Avx2.Shuffle(va.As<T, uint>(), control).As<uint, T>();
        ...
        /// <remarks>VPADDB ymm, ymm, ymm/m256</remarks>
        /// <remarks>
        ///     Description: Shuffle 64-bit integers in a across lanes using the control in imm8, and store the results in
        ///     dst.
        /// </remarks>
        /// <remarks>Supports: AVX(float, double), AVX2</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        {
            if (typeof(T) == typeof(long)) return Avx2.Permute4x64(va.As<T, long>(), control).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Avx2.Permute4x64(va.As<T, ulong>(), control).As<ulong, T>();
            if (typeof(T) == typeof(double)) return Avx2.Permute4x64(va.As<T, double>(), control).As<double, T>();
        ...
        /// <remarks>
        ///     Description: Copy a to dst, then insert 128 bits (composed of integer data) from b into dst at the location
        ///     specified by imm8.
        /// </remarks>
        /// <remarks>Supports: AVX2</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        internal static Vector256<T> UnpackLowVector256(Vector256<T> value, Vector256<T> data)
        {
            ...
            if (typeof(T) == typeof(byte)) return Avx2.UnpackLow(value.As<T, byte>(), data.As<T, byte>()).As<byte, T>();
            if (typeof(T) == typeof(short))
            ...
            if (typeof(T) == typeof(int)) return Avx2.UnpackLow(value.As<T, int>(), data.As<T, int>()).As<int, T>();
            if (typeof(T) == typeof(uint)) return Avx2.UnpackLow(value.As<T, uint>(), data.As<T, uint>()).As<uint, T>();
            if (typeof(T) == typeof(long)) return Avx2.UnpackLow(value.As<T, long>(), data.As<T, long>()).As<long, T>();
            if (typeof(T) == typeof(ulong))
        ...
        /// <remarks>VPUNPCKLBW ymm, ymm, ymm/m25</remarks>
        /// <remarks>
        ///     Description: Unpack and interleave 8-bit integers from the high half of each 128-bit lane in a and b, and
        ...
        internal static Vector256<T> UnpackHighVector256(Vector256<T> value, Vector256<T> data)
        {
            ...
            if (typeof(T) == typeof(int)) return Avx2.UnpackHigh(value.As<T, int>(), data.As<T, int>()).As<int, T>();
            if (typeof(T) == typeof(uint))
        ...
        /// <remarks>
        ///     Description: Subtract packed 8-bit integers in b from packed 8-bit integers in a, and store the results in
        ///     dst.
        /// </remarks>
        /// <remarks>Supports: AVX(float, double), AVX2</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Avx2.Subtract(va.As<T, sbyte>(), vb.As<T, sbyte>()).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Avx2.Subtract(va.As<T, byte>(), vb.As<T, byte>()).As<byte, T>();
            if (typeof(T) == typeof(short)) return Avx2.Subtract(va.As<T, short>(), vb.As<T, short>()).As<short, T>();
            if (typeof(T) == typeof(ushort))
                return Avx2.Subtract(va.As<T, ushort>(), vb.As<T, ushort>()).As<ushort, T>();
            if (typeof(T) == typeof(int)) return Avx2.Subtract(va.As<T, int>(), vb.As<T, int>()).As<int, T>();
            if (typeof(T) == typeof(uint)) return Avx2.Subtract(va.As<T, uint>(), vb.As<T, uint>()).As<uint, T>();
            if (typeof(T) == typeof(long)) return Avx2.Subtract(va.As<T, long>(), vb.As<T, long>()).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Avx2.Subtract(va.As<T, ulong>(), vb.As<T, ulong>()).As<ulong, T>();
            if (typeof(T) == typeof(float)) return Avx.Subtract(va.As<T, float>(), vb.As<T, float>()).As<float, T>();
            if (typeof(T) == typeof(double))
        ...
        /// <remarks>
        ///     Description: Load 256-bits of integer data from memory into dst. mem_addr does not need to be aligned on any
        ///     particular boundary.
        /// </remarks>
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Avx.LoadVector256((sbyte*) address).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Avx.LoadVector256((byte*) address).As<byte, T>();
            if (typeof(T) == typeof(short)) return Avx.LoadVector256((short*) address).As<short, T>();
            if (typeof(T) == typeof(ushort)) return Avx.LoadVector256((ushort*) address).As<ushort, T>();
            if (typeof(T) == typeof(int)) return Avx.LoadVector256((int*) address).As<int, T>();
            if (typeof(T) == typeof(uint)) return Avx.LoadVector256((uint*) address).As<uint, T>();
            if (typeof(T) == typeof(long)) return Avx.LoadVector256((long*) address).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Avx.LoadVector256((ulong*) address).As<ulong, T>();
            if (typeof(T) == typeof(float)) return Avx.LoadVector256((float*) address).As<float, T>();
            if (typeof(T) == typeof(double)) return Avx.LoadVector256((double*) address).As<double, T>();
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Avx.LoadDquVector256((sbyte*) address).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Avx.LoadDquVector256((byte*) address).As<byte, T>();
            if (typeof(T) == typeof(short)) return Avx.LoadDquVector256((short*) address).As<short, T>();
            if (typeof(T) == typeof(ushort)) return Avx.LoadDquVector256((ushort*) address).As<ushort, T>();
            if (typeof(T) == typeof(int)) return Avx.LoadDquVector256((int*) address).As<int, T>();
            if (typeof(T) == typeof(uint)) return Avx.LoadDquVector256((uint*) address).As<uint, T>();
            if (typeof(T) == typeof(long)) return Avx.LoadDquVector256((long*) address).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Avx.LoadDquVector256((ulong*) address).As<ulong, T>();
        ...
        /// <remarks>
        ///     Description: Store 256-bits of integer data from a into memory. mem_addr does not need to be aligned on any
        ///     particular boundary.
        /// </remarks>
        /// <remarks>Supports: AVX</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Vector256.Create(Unsafe.As<T, sbyte>(ref value)).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Vector256.Create(Unsafe.As<T, byte>(ref value)).As<byte, T>();
            if (typeof(T) == typeof(short)) return Vector256.Create(Unsafe.As<T, short>(ref value)).As<short, T>();
            if (typeof(T) == typeof(ushort)) return Vector256.Create(Unsafe.As<T, ushort>(ref value)).As<ushort, T>();
            if (typeof(T) == typeof(int)) return Vector256.Create(Unsafe.As<T, int>(ref value)).As<int, T>();
            if (typeof(T) == typeof(uint)) return Vector256.Create(Unsafe.As<T, uint>(ref value)).As<uint, T>();
            if (typeof(T) == typeof(long)) return Vector256.Create(Unsafe.As<T, long>(ref value)).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Vector256.Create(Unsafe.As<T, ulong>(ref value)).As<ulong, T>();
            if (typeof(T) == typeof(float)) return Vector256.Create(Unsafe.As<T, float>(ref value)).As<float, T>();
            if (typeof(T) == typeof(double)) return Vector256.Create(Unsafe.As<T, double>(ref value)).As<double, T>();
        ...
        /// <remarks>
        ///     Description: Subtract packed X-bit integers in b from packed X-bit integers in a, and store the results in
        ///     dst.
        /// </remarks>
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Sse2.Subtract(va.As<T, sbyte>(), vb.As<T, sbyte>()).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Sse2.Subtract(va.As<T, byte>(), vb.As<T, byte>()).As<byte, T>();
            if (typeof(T) == typeof(short)) return Sse2.Subtract(va.As<T, short>(), vb.As<T, short>()).As<short, T>();
            if (typeof(T) == typeof(ushort))
                return Sse2.Subtract(va.As<T, ushort>(), vb.As<T, ushort>()).As<ushort, T>();
            if (typeof(T) == typeof(int)) return Sse2.Subtract(va.As<T, int>(), vb.As<T, int>()).As<int, T>();
            if (typeof(T) == typeof(uint)) return Sse2.Subtract(va.As<T, uint>(), vb.As<T, uint>()).As<uint, T>();
            if (typeof(T) == typeof(long)) return Sse2.Subtract(va.As<T, long>(), vb.As<T, long>()).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Sse2.Subtract(va.As<T, ulong>(), vb.As<T, ulong>()).As<ulong, T>();
        ...
        /// <remarks>
        ///     Description: Load 128-bits of integer data from memory into dst. mem_addr does not need to be aligned on any
        ///     particular boundary.
        /// </remarks>
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Sse3.LoadDquVector128((sbyte*) address).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Sse3.LoadDquVector128((byte*) address).As<byte, T>();
            if (typeof(T) == typeof(short)) return Sse3.LoadDquVector128((short*) address).As<short, T>();
            if (typeof(T) == typeof(ushort)) return Sse3.LoadDquVector128((ushort*) address).As<ushort, T>();
            if (typeof(T) == typeof(int)) return Sse3.LoadDquVector128((int*) address).As<int, T>();
            if (typeof(T) == typeof(uint)) return Sse3.LoadDquVector128((uint*) address).As<uint, T>();
            if (typeof(T) == typeof(long)) return Sse3.LoadDquVector128((long*) address).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Sse3.LoadDquVector128((ulong*) address).As<ulong, T>();
        ...
        /// <remarks>
        ///     Description: Addition packed X-bit integers in b from packed X-bit integers in a, and store the results in
        ///     dst.
        /// </remarks>
        /// <remarks>Supports: SSE2</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Sse2.Add(va.As<T, sbyte>(), vb.As<T, sbyte>()).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Sse2.Add(va.As<T, byte>(), vb.As<T, byte>()).As<byte, T>();
            if (typeof(T) == typeof(short)) return Sse2.Add(va.As<T, short>(), vb.As<T, short>()).As<short, T>();
            if (typeof(T) == typeof(ushort)) return Sse2.Add(va.As<T, ushort>(), vb.As<T, ushort>()).As<ushort, T>();
            if (typeof(T) == typeof(int)) return Sse2.Add(va.As<T, int>(), vb.As<T, int>()).As<int, T>();
            if (typeof(T) == typeof(uint)) return Sse2.Add(va.As<T, uint>(), vb.As<T, uint>()).As<uint, T>();
            if (typeof(T) == typeof(long)) return Sse2.Add(va.As<T, long>(), vb.As<T, long>()).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Sse2.Add(va.As<T, ulong>(), vb.As<T, ulong>()).As<ulong, T>();
            if (typeof(T) == typeof(float)) return Sse.Add(va.As<T, float>(), vb.As<T, float>()).As<float, T>();
            if (typeof(T) == typeof(double)) return Sse2.Add(va.As<T, double>(), vb.As<T, double>()).As<double, T>();
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Sse2.LoadVector128((sbyte*) address).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Sse2.LoadVector128((byte*) address).As<byte, T>();
            if (typeof(T) == typeof(short)) return Sse2.LoadVector128((short*) address).As<short, T>();
            if (typeof(T) == typeof(ushort)) return Sse2.LoadVector128((ushort*) address).As<ushort, T>();
            if (typeof(T) == typeof(int)) return Sse2.LoadVector128((int*) address).As<int, T>();
            if (typeof(T) == typeof(uint)) return Sse2.LoadVector128((uint*) address).As<uint, T>();
            if (typeof(T) == typeof(long)) return Sse2.LoadVector128((long*) address).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Sse2.LoadVector128((ulong*) address).As<ulong, T>();
            if (typeof(T) == typeof(float)) return Sse.LoadVector128((float*) address).As<float, T>();
            if (typeof(T) == typeof(double)) return Sse2.LoadVector128((double*) address).As<double, T>();
        ...
        {
            if (typeof(T) == typeof(sbyte)) return Vector128.Create(Unsafe.As<T, sbyte>(ref value)).As<sbyte, T>();
            if (typeof(T) == typeof(byte)) return Vector128.Create(Unsafe.As<T, byte>(ref value)).As<byte, T>();
            if (typeof(T) == typeof(short)) return Vector128.Create(Unsafe.As<T, short>(ref value)).As<short, T>();
            if (typeof(T) == typeof(ushort)) return Vector128.Create(Unsafe.As<T, ushort>(ref value)).As<ushort, T>();
            if (typeof(T) == typeof(int)) return Vector128.Create(Unsafe.As<T, int>(ref value)).As<int, T>();
            if (typeof(T) == typeof(uint)) return Vector128.Create(Unsafe.As<T, uint>(ref value)).As<uint, T>();
            if (typeof(T) == typeof(long)) return Vector128.Create(Unsafe.As<T, long>(ref value)).As<long, T>();
            if (typeof(T) == typeof(ulong)) return Vector128.Create(Unsafe.As<T, ulong>(ref value)).As<ulong, T>();
            if (typeof(T) == typeof(float)) return Vector128.Create(Unsafe.As<T, float>(ref value)).As<float, T>();
            if (typeof(T) == typeof(double)) return Vector128.Create(Unsafe.As<T, double>(ref value)).As<double, T>();
        ...
        {
            if (typeof(T) == typeof(sbyte)) return SumVector(va);
            if (typeof(T) == typeof(byte)) return SumVector(va);
            if (typeof(T) == typeof(short))
            {
            ...
            if (typeof(T) == typeof(ushort)) return SumVector(va);
            if (typeof(T) == typeof(int))
            {
                var sum = va.As<T, int>();
                sum = Ssse3.HorizontalAdd(sum, sum);
            ...
            if (typeof(T) == typeof(uint)) return SumVector(va);
            if (typeof(T) == typeof(long)) return SumVector(va);
            if (typeof(T) == typeof(ulong)) return SumVector(va);
            if (typeof(T) == typeof(float))
            {
