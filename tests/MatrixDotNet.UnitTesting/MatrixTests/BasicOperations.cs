...
namespace MatrixDotNetTests.MatrixTests
{
    public class BasicOperations
    {
        ...
        {
            // Arrange
            var matrixA = new Matrix<double>(16, 16, 1);
            var expected = new Matrix<double>(16, 16, 16);
        ...
        {
            // Arrange
            var matrixA = new Matrix<int>(size, size, 1);
            var expected = new Matrix<int>(size, size, size);
        ...
        {
            // Arrange
            var matrixA = new Matrix<float>(size, size, 1);
            var expected = new Matrix<float>(size, size, size);
        ...
        {
            // Arrange
            var matrixA = BuildMatrix.RandomInt(1024, 1024, 1, 2);
            var matrixB = BuildMatrix.RandomInt(1024, 1024, 1, 2);
            var expected = matrixA * matrixB;
        ...
        public void MulVecByMatrixTests_AssertMustBeEqual()
        {
            ...
            Vector<int> expected = new[] { 50, 15, 9, 76 };
        ...
        public void MulMatrixByVecTests_AssertMustBeEqual()
        {
            ...
            Vector<int> vec = new[] { 2, 5, 1, 8 };
            Vector<int> expected = new[] { 4, 47, 5, 68 };
